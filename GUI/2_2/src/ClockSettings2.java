...
public class ClockSettings2 implements Cloneable {
	...
	// Specific Settings
	public ClockSettings2(String name, int size, Color fc, Color bgc) {
		this.font_name = name;
		this.font_size = size;
		this.font_color = fc;
	...
	@Override
    protected ClockSettings2 clone() {
        try {
            return (ClockSettings2) super.clone();

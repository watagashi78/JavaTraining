...
public class ClockPanel3 extends JPanel {
	private static final int MARGIN = 35;
	private SwingClock3 clock;
	private ClockSettings3 settings;

	public ClockPanel3(SwingClock3 clock) {
		this.clock = clock;
		this.settings = clock.getClockSettings();
		setClockSettings(this.settings);
	...
	public void setClockSettings(ClockSettings3 settings) {
